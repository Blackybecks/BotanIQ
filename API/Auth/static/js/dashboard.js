...
var soilhumidity_data = { labels: null, values: null };
...
$(document).ready(function () {
    ...
    $(window).resize(function() {
	    ...
	    createChart("soilhumidity_chart", soilhumidity_data);
	});
});
...
function loadAllChartData() {
	...
	loadChartData("/soilhumiditydata","soilhumidity_chart", soilhumidity_data);
}
